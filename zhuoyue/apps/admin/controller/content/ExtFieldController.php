        ...
        if ($_POST) {
            ...
            if (! $this->model->isExistField($name)) {
                if (get_db_type() == 'sqlite') {
                    ...
                    if($alt){
                       $result = $this->model->amd("ALTER TABLE ay_content_ext ADD COLUMN $alt $sqlite NULL");  
                    }

                    if($beifen){
                       $result = $this->model->amd("ALTER TABLE ay_content_ext ADD COLUMN $beifen $sqlite NULL");  
                    }
                } else {
