...
class IndexController extends Controller
{
    ...
    public function index()
    {
        if (session('sid')) {
         ...
         path_delete('runtime/complile',false);
    ...
    public function login()
    {
        ...
        if (! ! $login = $this->model->login($where)) {
            ...
            //备份数据库
        //    path_delete(DOC_PATH . STATIC_DIR . '/backup/sql/',$delDir = false);
        //    copy(DOC_PATH . $this->config('database')['dbname'], DOC_PATH . STATIC_DIR . '/backup/sql/' . get_uniqid() . '_' . date('YmdHis') . '.db');
    ...
    public function picture(){
        $this->display('system/picture.html');
    }
