    ...
    public function forgetpwd(){
        if ($_POST) {
            ...
            if($emailcode!=session('checkcode')){
                ...
                alert_location('验证成功！', Url::home('member/resetpwd'), 1);
            }
            ...
            $content = $this->parser->parserBefore($content); // CMS公共标签前置解析
            $content = str_replace('{pboot:pagetitle}', $this->config('index_title') ?: '忘记密码-{pboot:sitetitle}-{pboot:sitesubtitle}', $content);
