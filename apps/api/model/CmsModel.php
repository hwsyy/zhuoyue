...
class CmsModel extends Model
{
    ...
    // 列表内容,带分页
    public function getLists($scode, $num, $order, $filter = array(), $tags = array(), $select = array(), $fuzzy = true,$start,$lfield)
    {
        $fields = array(
            'a.*',
            'b.name as sortname',
    ...
    public function getLitpro($acode, $scode, $num, $order,$filter = array(), $tags = array(), $select = array(), $fuzzy = true)
    {
        $fields = array(
            'a.title as name',
            'a.id as value',
