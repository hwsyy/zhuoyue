...
class WeixinController extends Controller
{
    ...
    public function index()
    {
        ...
        $this->display('content/weixin.html');
    }
        ...
        if ($_POST) {
           ...
           /* if ($this->model->checkSortFilename($urlname)) {
            ...
            $data = array(
                ...
                'isdesc'=>post('isdesc'),
                'isenclosure'=>post('isenclosure'),
                'iscontent'=>post('iscontent'),
                'istags'=>post('istags'),
                'isauthor'=>post('isauthor'),
                'issource'=>post('issource'),
                'isico'=>post('isico'),
                'ispics'=>post('ispics'),
                'iscanshu'=>post('iscanshu'),
                'isurlname'=>post('isurlname'),
                'isurlink'=>post('isurlink'),
                'isdate'=>post('isdate'),
                'isseotitle'=>post('isseotitle'),
                'isseokeywords'=>post('isseokeywords'),
                'isseodescription'=>post('isseodescription'),
                'issystem' => 0,
